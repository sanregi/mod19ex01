...
def main():
    st.set_page_config(
        ...
        page_icon="https://github.com/sanregi/MOD-19/blob/main/ebac_logo-data_science.png?raw=true",
        layout="wide",
    ...
    <div style="text-align:center">
        <a href="https://github.com/sanregi/Portfolio">
            <img src="https://raw.githubusercontent.com/sanregi/MOD-19/4fe20a09f3ebd970f1648904822c7d24e491892b/ebac_logo-data_science.png" alt="ebac_logo-data_science" width=100%>
        </a>
    </div> 
    ...
    bank_raw = load_data(
        file_data='https://raw.githubusercontent.com/sanregi/MOD-19/main/banco%20de%20dados/bank-additional-full.csv', sep=';')
    bank = bank_raw.copy()
